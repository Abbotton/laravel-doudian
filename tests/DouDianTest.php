...
class DouDianTest extends TestCase
{
    ...
    public function test_all_requests_will_return_the_correct_response()
    {
        ...
        $classArray = ['afterSale', 'alliance', 'antiSpam', 'bats', 'buyIn', 'comment', 'coupons', 'crossBorder', 'iop', 'logistics', 'member', 'order', 'orderCode', 'product', 'shop', 'storage', 'spu', 'test', 'wareHouse', 'yunc'];
